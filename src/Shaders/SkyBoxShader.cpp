...
void SkyBoxShader::skyboxInitialize()
{
	...
	Use();
	setInt(uniformSkyBox, 0);
}

void SkyBoxShader::draw(glm::mat4 view,glm::mat4 project)
{
	// skybox
	...
	glm::mat4 viewM = glm::mat4(glm::mat3(view)); // remove translation from the view matrix
	//glm::mat4 projection;
